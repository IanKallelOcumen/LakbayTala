...
namespace Platformer.Model
{
    ...
    public class PlatformerModel
    {
        ...
        /// <summary>Minimum Tala (stars) required in this level to finish at the victory zone.</summary>
        public int requiredTalaToFinish = 1;

        /// <summary>Tala collected so far this level. Reset when level loads.</summary>
        public int currentTalaCollected = 0;
    }
}